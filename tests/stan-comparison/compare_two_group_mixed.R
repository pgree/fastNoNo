...
data_list <- list(n=n, k1=k1, k2=k2, y=y, sd_beta2=sd_beta2, sdy=sdy, sd_sigma1=sd_sigma1, X1=X1, X2=X2)
...
fit_fastnono <- fit_two_group_mixed(y, X1, X2, sd_beta2 = rep(1, k2), sd_sigma_y = sdy, sd_sigma1 = sd_sigma1, nnt = 20)
